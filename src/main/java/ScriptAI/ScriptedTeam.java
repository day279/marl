...
/**
 * ScriptedTeam allows baseline performance analysis for other team times.
 * This implementation moves units in a fixed, cyclical direction until they are all dead.
 *
 */
