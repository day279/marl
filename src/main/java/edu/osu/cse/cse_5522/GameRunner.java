...
/**
 * This is the primary entry point to the application.
 *
 */
public class GameRunner {
	/**
	 * 
	 * @param args Args are player 1 type and player 2 type, required.
	 * Possible values are: 'cooperative', 'independent', 'oracle', and 'scripted'
	 */
	public static void main(String[] args) {
		if (args.length < 2) {
			System.out.println("Please include the types for teams 1 and 2.");
			System.out.println("Valid options are cooperative, independent, oracle, and scripted.");
			return;
		} else {
			int numberOfGames = 1;
			if (args.length > 2) {
